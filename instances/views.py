   ...
   #messages = []
    ...
    try:
        ...
        if request.method == 'POST':
            ...
            if 'snapshot_disk_create' in request.POST and allow_admin_or_not_template:
            ...
            if 'snapshot_disk_rollback' in request.POST and allow_admin_or_not_template:
                dev = request.POST.get('disk_dev', '')
                snap_name = request.POST.get('snap_name', '')
                disk_path = get_disk_path(dev)
                if not disk_path:
            ...
            if 'snapshot_disk_remove' in request.POST and allow_admin_or_not_template:
                dev = request.POST.get('disk_dev', '')
                snap_name = request.POST.get('snap_name', '')
                disk_path = get_disk_path(dev)
                if not disk_path:
